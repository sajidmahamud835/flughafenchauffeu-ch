            ...
            <div className="mb-4">
                {
                    bookings.map((booking => {
                        if (booking._id === id) {
                            return (
                                <div className='container my-1 rouonded'>
                                    ...
                                    <div className='row'>
                                        <div className='col-5 container bg-light shadow-sm p-5'>
                                            ...
                                            <hr />
                                            <h6><strong>Status:</strong> <td><select value={booking.status} onChange={(e) => handleStatus(booking._id, e.target.value)} name="status" id="status">
