                        ...
                        <div>
                            {
                                addressSuggestion[inputName].items.map(item => (
                                    <div className="card-body ps-3 py-1 m-1 border border-light rounded inputSugesstion" key={item.id}>
                                        <h6 onClick={(e) => onAddressChange(e, item, inputName)} className="" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                            ...
                            }
                            {
                                ...
                                //     <h6 onClick={(e) => onAddressChange(e, addressSuggestion[inputName].items[0], inputName)} className="" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-compass-fill" viewBox="0 0 16 16">
